...
import static course.labs.todomanager.R.id.statusCheckBox;
import static course.labs.todomanager.R.id.statusDone;
...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// from todo_item.xml
		LayoutInflater itemLayoutInflater = LayoutInflater.from(mContext);
		convertView = itemLayoutInflater.inflate(R.layout.todo_item, parent, false);
		...
		final CheckBox statusView = (CheckBox) convertView.findViewById(statusCheckBox);
		/*
