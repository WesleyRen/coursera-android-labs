...
public class GoToDangerousActivity extends Activity {
	...
	private void startDangerousActivity() {
		...
		Intent startIntentToDangAct = new Intent(DANGEROUS_ACTIVITY_ACTION);

		Log.i(TAG, "startIntentToDangAct Action: " + startIntentToDangAct.getAction());

		startActivity(startIntentToDangAct);
